...
<slides>
  ...
  <div if={ estaOculto }>
      ...
      <div class="container">
        ...
        <div class="row fh5co-feature">
          <div class="flexcontainer">
              <div>
                  <button type="button" name="button" onclick={ cambiarOculto }>Ver presentacion</button>
              </div>
              <div>
        ...
        <!-- END feature -->
        <h1 id="idTres"> este el id tres</h1>
    ...
    <div id="get-started" style="background:#07A0C3;">
      <div class="container">
  ...
  <div if={ !estaOculto }>
    <div class="wrap"  onclick={ cambiarOcultoyClase }>
      <p>
