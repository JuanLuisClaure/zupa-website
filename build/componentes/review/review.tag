...
<review>
  ...
  <div class="fh5co-testimonial">
    <div class="container">
          ...
          <div class="col-8-xl col-8-l col-8-m">

            <div  each={ x in reviews }>

              <div class="mdl-card mdl-shadow--3dp {(x.state)? 'entrar':'none' }" if={ x.state } style="width:70%;">
                <div class="mdl-card__title mdl-card--expand" style="color: #fff;height: 176px;background:url({ x.img }) center / cover;">
                  <h2 class="mdl-card__title-text">{ x.autor }</h2>
                </div>
                ...
                <div class="mdl-card__actions mdl-card--border text-right">
                  <span class="review" each={ star in x.stars}>
          ...
          <div class="col-4-xl col-4-l col-4-m">

            <div class="row text-center fh5co-heading">
              <h2>Customer Review</h2>
            </div>
              <p>ksadkaskdaskdasdsadasdasssda
              sadasdasdasdas sa jska kasj kasj asaslasjca
             as asdjasjdasñ asideklsajdlas onloadedmetadata="datalist"
           sakldjaslkdjaslsa askalsd saldje cdsñlcks ceñslckes cac
          askdasldkjsad aslkdasidw </p>
          ...
          <div class="row text-center">
            <button class="col-6 mdl-button mdl-js-button mdl-button--icon" onclick={ atras } >
              <i class="material-icons">keyboard_arrow_left</i>
            </button>
            <button class="col-6 mdl-button mdl-js-button mdl-button--icon" onclick={ adelante }>
